...
export function StreamPlayer({
  ...
  return (
    <div className="bg-card border border-border rounded-lg overflow-hidden">
      {/* Video Player */}
      <div className="relative bg-card aspect-video flex items-center justify-center border border-border rounded-lg">
        {/* Live Indicator */}
        <div className="absolute top-4 left-4 z-10 flex items-center gap-2 bg-destructive/90 text-destructive-foreground px-3 py-1.5 rounded-full">
          <span className="w-2 h-2 bg-destructive-foreground rounded-full animate-pulse"></span>
          <span className="text-sm font-semibold">LIVE</span>
        </div>

        {/* Viewers Count */}
        <div className="absolute top-4 right-4 z-10 flex items-center gap-1.5 bg-card/70 text-foreground px-3 py-1.5 rounded-lg text-sm border border-border">
        ...
        {videoId ? (
          ...
          <>
            ...
            <a
              ...
              className="absolute bottom-4 right-4 z-10 p-2 bg-card/60 hover:bg-card/80 text-foreground rounded transition-colors border border-border"
          ...
          <>
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-background to-transparent p-6">
              ...
              <p className="text-muted-foreground text-sm mt-2">with {tutorName}</p>
            </div>
          </>
        )}
      </div>
